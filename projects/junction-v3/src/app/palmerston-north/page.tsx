...
export const metadata: Metadata = {
  title: 'AI Marketing Agency Palmerston North | Junction Media',
  description: 'Palmerston North AI marketing consultant and fractional CMO. Tom Hall-Taylor helps select ManawatÅ«-Whanganui businesses build AI-native marketing operations that compound over time.',
  keywords: 'marketing agency Palmerston North, digital marketing Palmerston North, AI marketing Palmerston North, fractional CMO Palmerston North, marketing consultant Palmerston North, ManawatÅ« marketing agency',
  openGraph: {
    title: 'AI Marketing Agency Palmerston North | Junction Media',
    description: 'Palmerston North AI marketing consultant. Fractional CMO for select ManawatÅ«-Whanganui businesses ready to build AI-native marketing operations.',
    url: 'https://www.junctionmedia.ai/palmerston-north',
    siteName: 'Junction Media',
    locale: 'en_NZ',
    type: 'website',
  },
  alternates: {
    canonical: 'https://www.junctionmedia.ai/palmerston-north',
  },
}

export default function PalmerstonNorthPage() {
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="max-w-3xl mx-auto px-6 pt-20 pb-16">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 leading-tight mb-6">
          ...
          <span className="text-gray-500">Palmerston North</span>
        </h1>
        <p className="text-xl text-gray-600 leading-relaxed mb-8">
          I&apos;m Tom Hall-Taylor â€” an NZ-based AI marketing consultant and fractional CMO. 
          I work with select Palmerston North and ManawatÅ«-Whanganui businesses to build 
          marketing operations that compound over time, not campaigns that stop when the 
          budget runs out.
        </p>
      ...
      <section className="max-w-3xl mx-auto px-6 py-16 border-t border-gray-100">
        <h2 className="text-2xl font-bold mb-8">What I Do for Palmerston North Businesses</h2>
      ...
      <section className="max-w-3xl mx-auto px-6 py-16 border-t border-gray-100">
        <h2 className="text-2xl font-bold mb-6">Why Palmerston North Businesses Work With Me</h2>
        <div className="space-y-6">
          <p className="text-gray-600 leading-relaxed">
            Palmerston North sits at the heart of the ManawatÅ«-Whanganui region â€” one of New 
            Zealand&apos;s most economically diverse areas. Food and agriculture, manufacturing, 
            logistics, and a thriving education sector anchored by Massey University give the 
            region a varied and resilient business base. But Palmerston North businesses are 
            often underserved by marketing agencies that focus on the main centres.
          </p>
          <p className="text-gray-600 leading-relaxed">
            I built Junction Media differently. I work with a maximum of 3â€“5 clients at any time. 
            That cap is intentional â€” it&apos;s how I give each business the attention and strategic 
            depth that actually moves the needle. You deal directly with me, not an account manager 
            in a large agency machine.
          </p>
          <p className="text-gray-600 leading-relaxed">
            ...
            especially in a regional market like Palmerston North where marketing budgets are 
            often tighter and ROI expectations are higher.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-6 py-16 border-t border-gray-100">
        ...
        <div className="space-y-8">
          {[
            {
              q: 'Are you based in Palmerston North?',
              a: 'I\'m based in Auckland but work with businesses across New Zealand, including Palmerston North and the wider ManawatÅ«-Whanganui region. Most of our work happens remotely via video calls and shared systems â€” location isn\'t a constraint for modern marketing strategy.'
            },
            {
            ...
            {
              q: 'How is this different from a Palmerston North marketing agency?',
      ...
      <section className="max-w-3xl mx-auto px-6 py-20 border-t border-gray-100">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-lg mx-auto">
            I&apos;m selective about who I work with. If you&apos;re a Palmerston North or ManawatÅ«-Whanganui 
            business serious about building AI-native marketing â€” apply below.
          </p>
          <Link
            href="/#apply"
