...
export const metadata: Metadata = {
  title: 'AI Marketing Consultant Tauranga | Tom Hall-Taylor | Junction Media',
  description: 'Tauranga AI marketing consultant and fractional CMO. Tom Hall-Taylor helps select Tauranga and Bay of Plenty businesses build AI-native marketing operations that compound over time.',
  keywords: 'AI marketing consultant Tauranga, fractional CMO Tauranga, marketing consultant Tauranga, digital marketing Tauranga, AI marketing Tauranga, marketing agency Tauranga, marketing strategist Tauranga, Bay of Plenty marketing',
  openGraph: {
    title: 'AI Marketing Consultant Tauranga | Tom Hall-Taylor',
    description: 'Tauranga AI marketing consultant. Fractional CMO for select Bay of Plenty businesses ready to build AI-native marketing operations.',
    url: 'https://www.junctionmedia.ai/tauranga',
    siteName: 'Junction Media',
    locale: 'en_NZ',
    type: 'website',
  },
  alternates: {
    canonical: 'https://www.junctionmedia.ai/tauranga',
  },
}

export default function TaurangaPage() {
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="max-w-3xl mx-auto px-6 py-16 border-t border-gray-100">
        <h2 className="text-2xl font-bold mb-8">What I Do for Tauranga Businesses</h2>
