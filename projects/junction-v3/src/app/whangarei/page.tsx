      ...
      <section className="max-w-3xl mx-auto px-6 py-16 border-t border-gray-100">
        ...
        <div className="space-y-6">
          <p className="text-gray-600 leading-relaxed">
            Whangarei is Northland&apos;s commercial hub — and it&apos;s more interesting than its 
          ...
          <p className="text-gray-600 leading-relaxed">
            Northland businesses often operate in a competitive vacuum at the local level — there 
            aren&apos;t many local competitors — but compete nationally or internationally in their 
            ...
            builds genuine authority — through SEO, thought leadership, and systematic social 
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            people about it. AI-native marketing systems fix this asymmetry — they produce 
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            businesses I work with get my direct attention — not a handoff to a junior account 
          ...
          {[
            {
              ...
              a: 'I\'m based in Auckland but work with businesses across Northland and New Zealand. Most of our work happens remotely via video calls and shared systems — location isn\'t a constraint for modern marketing strategy. Auckland to Whangarei is also a straightforward drive when in-person makes sense.'
            },
            {
              q: 'Do you work with marine and industrial businesses?',
              a: 'Yes — I work with B2B and trade businesses including those in manufacturing, marine, construction, and industrial services. Understanding your buyers and building marketing that reaches them effectively is what I do, regardless of sector.'
            },
            {
