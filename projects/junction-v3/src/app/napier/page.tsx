...
export const metadata: Metadata = {
  title: 'AI Marketing Agency Napier | Junction Media',
  description: 'Napier and Hawke\'s Bay AI marketing consultant and fractional CMO. Tom Hall-Taylor helps select Napier businesses in wine, tourism, and horticulture build AI-native marketing that compounds.',
  keywords: 'marketing agency Napier, digital marketing Napier, Hawke\'s Bay marketing agency, AI marketing Napier, fractional CMO Napier, marketing consultant Napier NZ',
  openGraph: {
    title: 'AI Marketing Agency Napier | Junction Media',
    description: 'Napier AI marketing consultant. Fractional CMO for select Hawke\'s Bay businesses ready to build AI-native marketing operations that compound over time.',
    url: 'https://www.junctionmedia.ai/napier',
    siteName: 'Junction Media',
    locale: 'en_NZ',
    type: 'website',
  },
  alternates: {
    canonical: 'https://www.junctionmedia.ai/napier',
  },
}

export default function NapierPage() {
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="max-w-3xl mx-auto px-6 pt-20 pb-16">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 leading-tight mb-6">
          ...
          <span className="text-gray-500">Napier &amp; Hawke&apos;s Bay</span>
        </h1>
        <p className="text-xl text-gray-600 leading-relaxed mb-8">
          I&apos;m Tom Hall-Taylor â€” an NZ-based AI marketing consultant and fractional CMO. 
          I work with select Napier and Hawke&apos;s Bay businesses to build marketing operations 
          that compound over time â€” built for the region&apos;s wine, tourism, horticulture, 
      ...
      <section className="max-w-3xl mx-auto px-6 py-16 border-t border-gray-100">
        <h2 className="text-2xl font-bold mb-8">What I Do for Napier &amp; Hawke&apos;s Bay Businesses</h2>
      ...
      {/* Why Napier */}
      <section className="max-w-3xl mx-auto px-6 py-16 border-t border-gray-100">
        <h2 className="text-2xl font-bold mb-6">Why Napier &amp; Hawke&apos;s Bay Businesses Work With Me</h2>
        <div className="space-y-6">
          <p className="text-gray-600 leading-relaxed">
            Hawke&apos;s Bay is one of New Zealand&apos;s most distinctive regional economies. The wine 
            industry draws international attention â€” but the region&apos;s economic base extends well 
            beyond viticulture into horticulture, tourism, food production, and a growing 
            professional services community centred on Napier and Hastings. These businesses 
            deserve marketing that understands their market and their audience, not generic 
            agency output.
          </p>
          <p className="text-gray-600 leading-relaxed">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            especially in a regional market like Hawke&apos;s Bay where marketing budgets are often 
            tighter and the connection between marketing and revenue needs to be direct and 
            measurable.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-6 py-16 border-t border-gray-100">
        ...
        <div className="space-y-8">
          {[
            {
              q: 'Are you based in Napier?',
              a: 'I\'m based in Auckland but work with businesses across New Zealand, including Napier and the wider Hawke\'s Bay region. Most of our work happens remotely via video calls and shared systems â€” location isn\'t a constraint for modern marketing strategy.'
            },
            {
            ...
            {
              q: 'How is this different from a Napier marketing agency?',
      ...
      <section className="max-w-3xl mx-auto px-6 py-20 border-t border-gray-100">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-lg mx-auto">
            I&apos;m selective about who I work with. If you&apos;re a Napier or Hawke&apos;s Bay business 
