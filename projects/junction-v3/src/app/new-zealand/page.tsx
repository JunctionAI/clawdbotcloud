    ...
    <main className="min-h-screen bg-white text-gray-900">
          ...
          {[
            {
              ...
              desc: 'Senior marketing leadership without the full-time salary. I embed in your business, own the marketing function, and drive results â€” for a fraction of what a CMO hire costs.'
            },
            {
            ...
            },
            {
              ...
              desc: 'Meta Ads and Google Ads managed with AI-driven optimisation. Not set-and-forget â€” active management with real accountability.'
            },
            {
              title: 'Growth Strategy', link: '/services/',
              desc: 'Clear positioning, 90-day roadmaps, and channel strategy built around your specific business and market â€” not a templated playbook.'
            },
          ].map((service) => (
      ...
      <section className="max-w-3xl mx-auto px-6 py-16 border-t border-gray-100">
        ...
        <div className="space-y-6">
          <p className="text-gray-600 leading-relaxed">
            ...
            are expensive relative to market size. And the real opportunity â€” AI-native marketing â€” 
            is still largely untapped by NZ businesses.
          </p>
          <p className="text-gray-600 leading-relaxed">
            I&apos;ve built Junction Media specifically to serve the $1Mâ€“$20M NZ business: established 
            enough to need real marketing leadership, too small to justify a full in-house team. 
            By using AI systems for execution, I can deliver what a 10-person agency delivers â€” 
            at a cost that makes sense for the NZ market.
          </p>
          <p className="text-gray-600 leading-relaxed">
            I work with a maximum of 3â€“5 clients at any time. That&apos;s a deliberate constraint â€” 
      ...
      <section className="max-w-3xl mx-auto px-6 py-16 border-t border-gray-100">
        ...
        <p className="text-gray-600 leading-relaxed mb-8">
          Based in Auckland, I work with businesses across New Zealand â€” both in-person 
      ...
      <section className="max-w-3xl mx-auto px-6 py-16 border-t border-gray-100">
        ...
        <div className="bg-gray-50 rounded-2xl p-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            Deep Blue Health â€” a New Zealand supplement brand â€” achieved their best revenue 
      ...
      <section className="max-w-3xl mx-auto px-6 py-16 border-t border-gray-100">
        ...
        <div className="space-y-4">
          {[
            'NZ businesses doing $1Mâ€“$20M who need senior marketing strategy without a full-time CMO',
            ...
            <div key={i} className="flex gap-3 items-start">
              <span className="text-gray-300 mt-1 flex-shrink-0">â€”</span>
          ...
          {[
            {
              ...
              a: 'No â€” I work with businesses across New Zealand. I\'m Auckland-based, but I work remotely with clients in Wellington, Christchurch, Hamilton, Tauranga, and beyond. Most of our work happens via video calls and shared systems anyway.'
            },
            {
              q: 'How is a fractional CMO different from a marketing agency?',
              a: 'An agency sells services â€” SEO, ads, content. They don\'t own strategy. A fractional CMO is embedded in your leadership team, owns marketing outcomes, and drives the strategy. I work with 3â€“5 clients max, not 30. You get direct access to me, not an account manager.'
            },
            {
              q: 'What does an engagement cost?',
              a: 'I work on monthly retainer. Pricing depends on scope â€” whether you need strategy-only, or strategy plus execution. Engagements start from $5k/month. The right question is whether the ROI justifies it: if I can help you grow revenue by $20k+/month, the math is straightforward.'
            },
            {
              q: 'How do you use AI differently from a regular agency?',
              a: 'AI is the execution infrastructure, not a gimmick. I use AI systems to produce content at scale, analyse performance data in real-time, manage ad creative testing, build automated marketing workflows, and deliver reporting. One person with AI does what a 5â€“10 person team used to do.'
            },
            {
              q: 'What\'s the minimum commitment?',
              a: 'I work in 3-month minimum engagements. Marketing compounds â€” it doesn\'t produce results in 30 days. 3 months is the minimum to see meaningful data and build the systems that actually change a business trajectory.'
            },
          ].map((faq) => (
            <div key={faq.q}>
      ...
      <section className="max-w-3xl mx-auto px-6 py-20 border-t border-gray-100">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-sm mt-4">3â€“5 clients at any time. Serious enquiries only.</p>
        </div>
      </section>
