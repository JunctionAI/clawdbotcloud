...
// Use Deep Blue Health account (second one)
const account = creds.accounts[1];
...
const getRecentEmails = async () => {
  ...
  return new Promise((resolve, reject) => {
    const path = `/v1.0/users/${encodeURIComponent(account.email)}/mailFolders/inbox/messages?$top=30&$orderby=receivedDateTime desc`;
